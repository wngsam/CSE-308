...
<!--FOOTER-->	
        <div style="text-align:center;" class="panel-footer">
			<footer>
				<table align="center" width="100%"><tr valign="top"><td width="25%"><p style="font-size:20px">EXPERIENCE + EXPLORE</p><p><a href="">Movie Times</a></p><p><a href="">Movies In Theaters</a></p><p><a href="">Mobile</a></p><p><a href="">New DVD Releases</a></p><p><a href="offersPage.htm">Special Offers</a></p><p><a href="">Gift Cards</a></p></td>
				...
				<table align="center" width="100%"  bgcolor="#00FF00"><tr valign="top"><td width="25%"><p style="font-size:20px">Get Updates On All Things Movies:</p><p>Sign up for FanMail</p>
					<form class="navbar-form navbar-center">
						...
						</div></form><br><br><br><p><a href="">SIGN UP FOR FANTEXTS</a></p></td>
					<td width="25%"><p style="font-size:20px">Follow Us</p><p><a href="" class ="highlight_footerIcon"><img src="assets\img\facebook_icon.png" alt="Facebook" style="width:40px;height:40px"></a>&nbsp&nbsp
					...
					<td width="25%"><p style="font-size:20px">Get Samdango Apps</p>
